...

{
	...
	public void site1() throws IOException {
		...
		ImageIO.write(ss.getImage(), "PNG", new File("./AllScreenshot/chrome_1536x864_site1" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site2() throws IOException {
		...
		driver.manage().window().setSize(new Dimension(1536, 864));
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG", new File("./AllScreenshot/chrome_1536x864_site2" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site3() throws IOException {
		...
		driver.manage().window().setSize(new Dimension(1536, 864));
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG", new File("./AllScreenshot/chrome_1536x864_site3" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site4() throws IOException {
		...
		driver.manage().window().setSize(new Dimension(1536, 864));
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG", new File("./AllScreenshot/chrome_1536x864_site4" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site5() throws IOException {
		...
		driver.manage().window().setSize(new Dimension(1536, 864));
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG", new File("./AllScreenshot/chrome_15356x864_site5" + timestamp + ".png"));
		driver.close();
	}
