...
//mobile resolution 360 x 640
{
	...
	public void site1() throws IOException {
		...
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/chrome_Mobile_360x640_site1" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site2() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/chrome_Mobile_360x640_site2" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site3() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/chrome_Mobile_360x640_site3" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site4() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/chrome_Mobile_360x640_site4" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site5() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/chrome_Mobile_360x640_site5" + timestamp + ".png"));
		driver.close();
	}
