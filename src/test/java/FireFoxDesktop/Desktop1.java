...
public class Desktop1 {
	...
	public void site1() throws IOException {
		...
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/Firefox_desktop_1920x1080_site1" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site2() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/Firefox_desktop_1920x1080_site2" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site3() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/Firefox_desktop_1920x1080_site3" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site4() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/Firefox_desktop_1920x1080_site4" + timestamp + ".png"));
		driver.close();
	}
	...
	public void site5() throws IOException {
		...
		PageSnapshot ss = Shutterbug.shootPage(driver, Capture.FULL, true);
		ImageIO.write(ss.getImage(), "PNG",
				new File("./AllScreenshot/Firefox_desktop_1920x1080_site5" + timestamp + ".png"));
		driver.close();
	}
